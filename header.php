...
<body class="<?= is_front_page() ? 'first-slide' : '' ?>">
	<?php wp_body_open(); ?>

	<header
		class="<?= ( is_front_page() || get_queried_object_id() == $blog_page_id[0] || is_category() ) ? '' : 'header-white' ?>">
		<div class="container header-large-view">
			...
			<div class="btn-column">
				...
				<a href="<?= the_permalink( $video_page_id[0] ); ?>" class="sing-up-btn"><i class="icon-play"></i>مشاهده
					ویدیوها</a>
				<a href="<?= the_permalink( $courses_page_id[0] ); ?>#courses" class="profile-btn"><i
						class="icon-note-book"></i></a>
