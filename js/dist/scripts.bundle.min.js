(() => {
  ...
  var testimonial = document.querySelectorAll("person-img");
  if (testimonial) {
    testimonial.forEach((person) => {
      person.addEventListener("click", () => {
        const eventName = "click", className = "active";
        (void 0)(person, className, testimonial);
        const videoContainer = document.querySelectorAll("video-container");
        videoContainer.forEach((video2) => {
          const ifContent = video2.getAttribute("data-id") == person.getAttribute("data-id");
          (void 0)(ifContent, className);
        });
        ...
        personInfo.forEach((info) => {
          ...
          (void 0)(content, className);
        });
      });
    });
  }
  var showVideo = document.querySelector(".video-container.active");
  if (showVideo) {
