(() => {
  ...
  var svgNotFound = document.querySelectorAll("#not-fond-animation svg");
  var womanSvg = document.querySelector("#woman-svg");
  var SpeechBubble = document.querySelector("#Speech_Bubble");
  ...
  var contactTl = gsapWithCSS.timeline();
