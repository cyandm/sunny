(() => {
  ...
  var shopSliderElement = document.querySelector(".shop-slider");
  var shopSlider = new Swiper(shopSliderElement, {
    slidesPerView: "auto",
    spaceBetween: 16,
    autoHeight: true,
    // loop: true,
  ...
  var homeMainSlider = document.querySelector(".home-main-slider");
  var frontMainSlider = new Swiper(homeMainSlider, __spreadProps(__spreadValues({}, defaultSwiper), {
    direction: "vertical",
    mousewheel: true,
    speed: 1e3,
    navigation: {
  ...
  var horizontalSliders = document.querySelectorAll(".home-nested-slider");
  horizontalSliders.forEach((slider, index) => {
    const horizontalSwiper = new Swiper(slider, __spreadProps(__spreadValues({}, defaultSwiper), {
      speed: 1e3,
      nested: true,
      mousewheel: true,
      navigation: {
  ...
  var aboutThumbnailSlideElement = document.querySelector(
    ".about-thumbnail-slider"
  );
  var aboutThumbnailSlider = new Swiper(aboutThumbnailSlideElement, {
    spaceBetween: 10,
    slidesPerView: "auto",
    freeMode: true
  });
  var aboutMainSliderElement = document.querySelector(".about-page-slider");
  var aboutMainSlider = new Swiper(aboutMainSliderElement, __spreadProps(__spreadValues({}, defaultSwiper), {
    speed: 1e3,
    thumbs: {
  ...
  var aboutNestedSlider = document.querySelectorAll(".about-nested-slider");
  aboutNestedSlider.forEach((aboutSlider) => {
    const aboutHorizontalSwiper = new Swiper(aboutSlider, __spreadProps(__spreadValues({}, defaultSwiper), {
      speed: 1e3,
      nested: true,
      navigation: {
        nextEl: ".swiper-button-next",
  ...
  // js/pages/front-page/testimonial.js
  ...
  // js/pages/front-page/blog-mobile.js
  ...
  // js/pages/front-page/front-animation.js
  gsapWithCSS.from(
    [
  ...
  // js/pages/front-page/start-video-popup.js
  ...
  // js/pages/front-page/coaches-popup.js
  ...
  // js/pages/front-page/start-section.js
  ...
  // js/pages/course/course-overview.js
  ...
  // js/pages/course/course-form.js
  var courseForms2 = document.querySelectorAll(".send-course-form");
  if (courseForms2) {
    courseForms2.forEach((courseForm, index) => {
  ...
  // js/pages/404-contact-animation.js
  ...
  // js/pages/about-popup-images.js
