(() => {
  ...
  var studentSliderPopup = new Swiper(".students-slider-popup", {
    slidesPerView: "auto",
    spaceBetween: 20,
    breakpoints: {
      992: {
  ...
  var shopSlider = new Swiper(shopSliderElement, {
    ...
    breakpoints: {
      768: __spreadProps(__spreadValues({}, defaultSwiper), {
        slidesPerColumn: 2,
        grid: {
          rows: 2
        }
      ...
      if (index == key) {
        ...
        courseForm.addEventListener("submit", (e) => {
          if (courseForm.id == e.target.id) {
            ...
            console.log(allData);
            let errors = [];
            Object.entries(allData).forEach(([key2, value]) => {
              ...
              const sanitizeInput = (input) => {
                ...
                if (input.match(symbolsPattern)) {
                  return "\u0644\u0637\u0641\u0627 " + fieldName(key2) + " \u0645\u0646\u0627\u0633\u0628 \u0648\u0627\u0631\u062F \u06A9\u0646\u06CC\u062F ";
                }
              };
              ...
              const integer = (id2) => {
                const isInteger = Number.isInteger(parseInt(id2));
                if (!isInteger) {
                  return "\u0644\u0637\u0641\u0627 \u0634\u0645\u0627\u0631\u0647 \u062F\u0648\u0631\u0647 \u0631\u0627 \u0648\u0627\u0631\u062F \u06A9\u0646\u06CC\u062F";
                }
              };
              if (value === "") {
                let error = fieldName(key2) + "  \u0636\u0631\u0648\u0631\u06CC \u0627\u0633\u062A ";
                errors.push(error);
              }
              if (!value == "" && key2 != "phone" && key2 != "date" && key2 != "course_id") {
              ...
              if (isArrayEmptyOrAllUndefined(errors)) {
                ...
                for (const [key3, value2] of Object.entries(allData)) {
                  formData.append(key3, value2);
                }
                xhr.send(formData);
              } else {
                submitForm.disabled = false;
