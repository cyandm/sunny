(() => {
  ...
  var mainSlider = new Swiper(".home-main-slider", {
    direction: "vertical",
    slidesPerView: 1,
    spaceBetween: 0,
    mousewheel: true,
  ...
  if (frontBlogSection || blogPage) {
    let height = function(firstHeight2) {
      if (blogPage) {
    ...
    if (window.innerWidth >= 768) {
      let tabCategory2 = document.querySelectorAll(".category-tab");
      console.log(tabCategory2);
      tabCategory2.forEach((category) => {
        category.addEventListener("click", (e) => {
          category.classList.add("active-cat");
          tabCategory2.forEach((cat) => {
            if (cat != category) {
  ...
  // js/modules/front/blog-mobile.js
          ...
          (blog) => {
            if (blog.classList.contains(slugCat)) {
              ...
              if (blogPage2) {
                ...
                window.onresize = function(event2) {
                  firstHeightMobile.parentElement.style.height = totalHeight + 25 + "px";
                };
              } else {
  ...
  if (mobileCategoryList) {
    let options2 = mobileCategoryList.querySelectorAll("option");
  ...
  var mainSlider2 = new Swiper(".about-page-slider", {
    slidesPerView: 1,
    spaceBetween: 0,
    mousewheel: true,
    speed: 1e3,
  ...
  if (form) {
    ...
    form.addEventListener("submit", function(e) {
      ...
      let allData = {};
      Array.from(form.querySelectorAll("input, textarea")).forEach(function(element) {
  ...
  gsapWithCSS.fromTo("#circle-animation ", {
    opacity: 0,
    scale: 0
  }, {
    duration: 0.5,
  ...
  var threeWeeksLater = new persianDate().add("days", 21).valueOf();
  var now = (/* @__PURE__ */ new Date(1601888766075)).getTime();
  var options = {
    altField: "#datepicker",
  ...
  var datePicker = new Datepicker(document.querySelector(".date-picker-custom"), options);
})();
