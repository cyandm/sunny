(() => {
  ...
  var frontMainSlider = new Swiper(".home-main-slider", {
    defaultSwiper,
    direction: "vertical",
    mousewheel: true,
    speed: 1e3
  ...
  var swiperThumbnail = new Swiper(".about-thumbnail-slider", {
    spaceBetween: 10,
    slidesPerView: 4,
    freeMode: true,
    speed: 1e3,
  ...
  var aboutMainSlider = new Swiper(".about-page-slider", {
    defaultSwiper,
    mousewheel: true,
    speed: 1e3,
    navigation: {
  ...
  var blogMainSlider2 = new Swiper(".blog-page-slider", {
    defaultSwiper,
    speed: 1e3,
    // mousewheel: true,
    mousewheel: {
  ...
  // js/modules/gsap-animation/front-animation.js
  ...
  // js/modules/gsap-animation/course-animation.js
  var coursePageAnimation = document.querySelector("#course-page");
  if (coursePageAnimation) {
    gsapWithCSS.registerPlugin(ScrollTrigger2);
    gsapWithCSS.from(".bg-top-radius", {
      duration: 1.7,
      y: "-700",
      top: "-100%",
      ease: "expo.inOut",
    ...
    gsapWithCSS.from(".img-title-animation", {
      duration: 1.5,
      delay: 1,
      opacity: 0,
      y: 30,
