(() => {
  ...
  var require_blogs_overview = __commonJS({
    "js/pages/blogs-overview.js"(exports) {
    ...
    menuItemsHasChildren.forEach((menuItem) => {
      menuItem.addEventListener("click", (e) => {
        ...
        if (menuItem.classList.contains("active-menu")) {
          ...
          style.innerHTML = "#".concat(subMenu, '::before {\n      content: "";\n      width:2px;\n     position: absolute;\n          right: 0.6rem;\n          top: 0.5rem;\n         background:  #e8e9ea;\n    height: ').concat(beforeHeight, ";\n  }");
        }
      });
    });
  }
  ...
  var frontMainSlider = new Swiper(".home-main-slider", __spreadProps(__spreadValues({}, defaultSwiper), {
    direction: "vertical",
    mousewheel: true,
    speed: 1e3,
    navigation: {
  ...
  var aboutThumbnailSlider = new Swiper(".about-thumbnail-slider", {
    spaceBetween: 10,
    slidesPerView: 4,
    freeMode: true
  });
  var aboutMainSlider = new Swiper(".about-page-slider", __spreadProps(__spreadValues({}, defaultSwiper), {
    speed: 1e3,
    thumbs: {
  ...
  gsapWithCSS.from([".custom-logo-link img", ".menu li.menu-item", ".btn-column  "], {
    duration: 1,
    opacity: 0,
    y: 30,
    ease: "expo.inOut",
  ...
  // js/pages/index.js
  var import_blogs_overview = __toESM(require_blogs_overview());
