...
<main class="contact-page" id="contact-page">
    <div class="contact-row container padding-top">
        <div class="contact-img">
            <?php
            get_template_part('assets/imgs/svg/contact', 'svg'); ?>
        </div>
        <div class="contact-page-form">
            ...
            <form method="post" action="" id="contact_form">
                ...
                <div class="form-input form-textarea">
                    ...
                    <textarea name="message" id="message" rows="7" maxlength="65525" placeholder=" متن پیام"></textarea>
                </div>
                <div class="form-btn">

                    <button id="submit_form" data-callback="ContactForm" type="submit"><i class="icon-send"></i>ارسال پیام
                    </button>
                </div>
            </form>
