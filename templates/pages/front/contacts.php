...
?>
<div id="front-contact" class=" front-contact-section">
			...
			<div class="contact-box-right">
				<div class="info">
					<?php if ( $whatsappTitle ) : ?>
						<a href="<?= $whatsappLink ?>">
							<?= $whatsappTitle ?><i class="icon-whatsapp"></i>
						</a>
					<?php endif;
					if ( $instagramTitle ) : ?>
						<a href="<?= $instagramLink ?>">
							<?= $instagramTitle ?><i class="icon-insta"></i>
						</a>

					<?php endif;
					if ( $telegramTitle ) : ?>
						<a href="<?= $telegramLink ?>">
							<?= $telegramTitle ?><i class="icon-telegram"></i>
						</a>
					<?php endif; ?>
				</div>
				<div class="images">
				...
				<div class="info">
					...
					<div class="maps-link">
						<?php foreach ( $mapLinks as $map ) : ?>
							<a href="<?= $map['map_link'] ?>">
								<?= wp_get_attachment_image( $map['map_image'], 'thumbnail', false, [] ); ?>
							</a>
						<?php endforeach; ?>
					</div>
				</div>
