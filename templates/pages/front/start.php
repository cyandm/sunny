                ...
                <div class="row">
                    <div class="container">
                        <div class="start-content">
                            ...
                            <div class="start-text">
                                ...
                                <div class="panels-navigation">
                                    <?php if ($num == 1) : ?>
                                        <div class="nav-panel next" data-sign="plus"><a href="#start-<?= $num + 1 ?>"
                                                                                        class="anchor"><i
                        ...
                        <div class="breadcrumb-btn">
                            <a href="#start-<?= ($num == count($startSliders)) ? $num - 1 : $num + 1 ?>"
                               class="btn-right"><i class="icon-arrow-side-right"></i>مربی ها و هنرجوها</a>
