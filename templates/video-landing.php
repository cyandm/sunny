                ...
                <?php foreach ($testimonialVideos as $videoItem) :
                    ...
                    if ($video) : ?>
                        <div class="video-part-content slide-video-popup">
                            ...
                            <?php $thumbnail_id = get_post_thumbnail_id($videoItem->ID); ?>
        ...
        <div class="container">
            ...
            <div class="video-row">
                ...
                <?php foreach ($coachesVideos as $videoCoach) :
                    $description = get_field("video_description_overview", $videoCoach->ID);
                    $video = get_field("attach_coach_video", $videoCoach->ID);
                    if ($video) : ?>
                        <div class="video-part-content slide-video-popup">
