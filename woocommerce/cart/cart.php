...
<div class="custom-cart-page container padding-top">
	<?php
	// add back btn
	get_template_part('/templates/components/back-btn');
	...
	<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
		...
		<div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
			...
			<div class="card-table-head">
				<div class="product-name">نام محصول</div>
				<div class="product-price">قیمت واحد</div>
				<div class="product-quantity"><?php esc_html_e('Quantity', 'woocommerce'); ?></div>
				<div class="product-subtotal">جمع کل</div>
			</div>
